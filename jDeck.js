...
siteFunctions = {
  ...
  'tempostorm.com': function() {
	...
	download = function(){update();deck.download($('h1.ng-binding').text() + '.txt')};
	copy = function(){update();deck.copy()};
  },
  'hearthpwn.com/deckbuilder': function() {
	...
	download = function(){update();deck.download($('.deck-name-container > h2').text() + '.txt')};
	copy = function(){update();deck.copy()};
  },
